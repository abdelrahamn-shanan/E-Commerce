                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('index.option')}}"> خيارات الخصائص </a>
                                </li>
                                <li class="breadcrumb-item active">تعديـل 
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> تعديل الخيارات  </h4>
                                    ...
                                    <div class="card-body">
                                        <form class="form"
                                            ...
                                            <input name="id" value="{{$option -> id}}" type="hidden">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i> بيانات الخصائص </h4>
                                                <div class="row">
                                                    <div class="col-md-6">
