...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{asset('assets/admin/vendors/'.getFolder().'/cryptocoins/cryptocoins.css')}}">
    <link rel="stylesheet" type="text/css"
        href="{{asset('assets/admin/vendors/'.getFolder().'/extensions/datedropper.min.css')}}">
    <link rel="stylesheet" type="text/css"
        href="{{asset('assets/admin/vendors/'.getFolder().'/extensions/timedropper.min.css')}}">
    <link rel="stylesheet" type="text/css"
        href="{{asset('assets/admin/vendors/'.getFolder().'/file-uploaders/dropzone.min.css')}}">
    <link rel="stylesheet" type="text/css"
...
<body class="vertical-layout vertical-menu 2-columns menu-expanded fixed-navbar" data-open="click"
    ...
    <script src="//js.pusher.com/3.1/pusher.min.js"></script> <!-- connect with pusher-->
    ...
    var pusher = new Pusher('a6e83ed08ba18fd07343', {
        encrypted: true
    });
