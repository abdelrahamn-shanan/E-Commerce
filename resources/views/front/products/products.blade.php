                                            ...
                                            <div class="product-buttons d-flex justify-content-center" itemprop="offers"
                                                ...
                                                <form action="" method="POST" class="formAddToCart">
                                                    ...
                                                    <a class="add-to-cart cart-addition"
                                                        ...
                                                        data-product-qty="{{$product -> qty}}"
                                                        href="{{Route('site.cart.add')}}"
...
@include('front.includes.cartalert')
@include('front.includes.cartalert2')
...
$(document).on('click', '.close', function() {
    ...
    $('.cartalert-modal').css("display", "none");
    $('.cartalert-modal2').css("display", "none");
...
$(document).on('click', '.cart-addition', function(e) {
    ...
    $.ajax({
        ...
        if (data != null) {
            $('.cartalert-modal').css('display', 'block');
        } else {
            $('.cartalert-modal2').css('display', 'block');
        }
    });
});
</script>
